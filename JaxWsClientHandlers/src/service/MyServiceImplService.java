 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://service/", wsdlLocation = "http://en32319:8080/HandlerChainExample/MyServiceImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://service/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://en32319:8080/HandlerChainExample/MyServiceImplService?wsdl");
    ...
    public MyServiceImpl getMyServiceImplPort() {
        return super.getPort(new QName("http://service/", "MyServiceImplPort"), MyServiceImpl.class);
    }
    ...
    public MyServiceImpl getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "MyServiceImplPort"), MyServiceImpl.class, features);
    }
